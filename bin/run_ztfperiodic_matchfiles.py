...
filenames = ["../input/obj.dat","../input/objLong.dat"]
outputDir = '../output_followup'
...
for filename in filenames:
    ...
    for line in lines:
        ...
        system_call = "python ztfperiodic_matchfiles.py --doPlots --doPhase --user mcoughli@caltech.edu --pwd mchoop --ra %.5f --declination %.5f --phase %.5f --outputDir %s --doJustHR"%(ra, dec, period, outputDir)
        print(system_call)
