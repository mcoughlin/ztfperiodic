...
class Periodogram():
    def __init__(self, periods, periodograms,
                 times=None, measurements=None, errors=None,
                 survey=None, name=None, label=None, metadata=None):
    ...
    def __repr__(self):
        return "Periodogram(" + ', '.join("{}={}".format(k, v)
                        for k, v in self.__dict__.items()) + ")"
