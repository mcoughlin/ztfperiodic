...
def get_featuresetnames(featuresetname):
    ...
    phenomenological = ['dmdt', 'ad', 'chi2red',
                        'f1_BIC', 'f1_a', 'f1_amp' ,'f1_b', 
                        'f1_phi0', 'f1_power', 'f1_relamp1',
                        'f1_relamp2', 'f1_relamp3', 'f1_relamp4',
                        'f1_relphi1', 'f1_relphi2', 'f1_relphi3',
                        'f1_relphi4', 'field', 
                        'i60r', 'i70r', 'i80r', 'i90r',
                        'inv_vonneumannratio', 'iqr', 
                        'mean_ztf_alert_braai', 'median',
                        'median_abs_dev', 'n_ztf_alerts', 'norm_excess_var',
                        'norm_peak_to_peak_amp', 'period',
                        'roms', 'significance', 'skew', 'smallkurt',
                        'stetson_j', 'stetson_k', 'sw', 'welch_i', 
                        'wmean', 'wstd']

    ontological = ['dmdt', 'ad', 'ccd', 'chi2red', 'dec',
                   'f1_BIC', 'f1_a', 'f1_amp' ,'f1_b',
                   'f1_phi0', 'f1_power', 'f1_relamp1',
                   'f1_relamp2', 'f1_relamp3', 'f1_relamp4',
                   'f1_relphi1', 'f1_relphi2', 'f1_relphi3',
